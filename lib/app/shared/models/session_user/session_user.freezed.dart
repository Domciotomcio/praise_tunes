...
abstract class $SessionUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String? instrument});
}
...
class _$SessionUserImpl implements _SessionUser {
  const _$SessionUserImpl(
      {required this.id, required this.name, this.instrument});
  ...
  @override
  String toString() {
    return 'SessionUser(id: $id, name: $name, instrument: $instrument)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, instrument);
...
abstract class _SessionUser implements SessionUser {
  const factory _SessionUser(
      ...
      final String? instrument}) = _$SessionUserImpl;
